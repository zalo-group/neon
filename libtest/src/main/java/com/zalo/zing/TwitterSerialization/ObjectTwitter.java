package com.zalo.zing.TwitterSerialization;
...
public class ObjectTwitter {
    ...
    public static class ObjectTwitterSerializer extends ObjectSerializer<ObjectTwitter> {
        ...
        @Override
        protected void serializeObject(@NonNull SerializationContext context, @NonNull SerializerOutput output, @NonNull ObjectTwitter object) throws IOException {
            ObjectOneTwitter.ZarcelObjectOneTwitterSerializer serializerObjectOne = new ObjectOneTwitter.ZarcelObjectOneTwitterSerializer();
            ObjectTwoTwitter.ZarcelObjectTwoTwitterSerializer serializerObjectTwo = new ObjectTwoTwitter.ZarcelObjectTwoTwitterSerializer();
            //------------ ZarcelObject version------------//
            output.writeInt(0);
            //========================== Version 0 ==========================//
            //------------ mFirstValue ------------//
        ...
        @Override
        protected ObjectTwitter deserializeObject(@NonNull SerializationContext context, @NonNull SerializerInput input, int versionNumber) throws IOException, ClassNotFoundException {
            ObjectOneTwitter.ZarcelObjectOneTwitterSerializer serializerObjectOne = new ObjectOneTwitter.ZarcelObjectOneTwitterSerializer();
            ObjectTwoTwitter.ZarcelObjectTwoTwitterSerializer serializerObjectTwo = new ObjectTwoTwitter.ZarcelObjectTwoTwitterSerializer();
            ...
            if (version > 0) {
                throw new IllegalArgumentException("ZarcelObject is outdated. Update ZarcelObject to deserialize newest binary data.");
            }
            if (version >= 0) {
