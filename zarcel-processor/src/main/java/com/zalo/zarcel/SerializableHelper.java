...
class SerializableHelper {
    static void writeObject(MethodSpec.Builder builder, String argClassName, String attribute, boolean nullableObject) {
        if (!nullableObject) {
    ...
    static void writeObjectArray(MethodSpec.Builder builder, ZarcelProperty property, String argClassName) {
    ...
    static void writePrimitive(MethodSpec.Builder builder, String primitiveType, String argClassName, String attribute) {
    ...
    static void writePrimitiveArray(MethodSpec.Builder builder, ZarcelProperty property, String argClassName) {
        beginArray(builder, property, argClassName, property.objectNullable());
        //==========Process with i========
        writePrimitive(builder, property.dataType().getValue(), argClassName, property.propertyName() + "[i]");
        //================================
        endArray(builder, property.objectNullable());
    }

    static void writeCustomAdapter(MethodSpec.Builder builder, ZarcelProperty property, String argClassName) {
        ...
        if (!property.objectNullable()) {
            builder.beginControlFlow("")
                    ...
                    .addStatement("tmp__customAdapter.serialize($L.$L,writer)", argClassName, propertyName);
    ...
    private static void beginArray(MethodSpec.Builder builder, ZarcelProperty property, String argClassName, boolean arrayNullable) {
        ...
        builder.addStatement("writer.writeInt32($L.$L.length)", argClassName, propertyName)
                .beginControlFlow("for (int i=0; i< $L.$L.length; i++)", argClassName, propertyName);
        // Do something with i
    }
